  ...
  return (
    <div>
      ...
      <div style={{ textAlign: "center", marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 13, color: "#55556A" }}>Create your account</p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ position: "relative" }}>
              <User size={13} style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: "#3A3A4E" }} />
              <input
                type="text"
                value={name}
      ...
      <p style={{ textAlign: "center", fontSize: 12, color: "#55556A", marginTop: 20 }}>
        ...
        <Link href="/login" style={{ color: "#4F8AFF", textDecoration: "none" }}>
          Sign in
        </Link>
      </p>
    </div>
